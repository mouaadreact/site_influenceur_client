...
import { deleteImageInGalerieOfOneCampagne, getGalerieOneCampagne } from '../../../../redux/actions/galerieCampagne.actions';
...
function PreviewGalerieCampagne({idCampagne}) {
  ...
  const {galerieOneCampagneData}=useSelector(state=>state.galerieCampagne)
