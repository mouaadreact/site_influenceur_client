...
import { getOneEtatPaiment, updateEtatPaiment } from '../../../../redux/actions/etatPaiment.actions';
...
function EditEtatPaiment() {
 ...
 const [inputValue,setInputValue]=useState({
  ...
  const handleEdit=(event)=>{
   ...
   updateEtatPaiment(params.campagneId,params.influenceurId,inputValue,dispatch);
  }
