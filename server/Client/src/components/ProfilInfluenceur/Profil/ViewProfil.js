         ...
         <div className="card mb-4">
           <div className="card-body">
             ...
             <div className="row">
               ...
               <div className="col-sm-9">
                 ...
                 && oneInfluenceurData.User
                  && oneInfluenceurData.User.username}</p>
               </div>
             </div>
             <hr/>
             <div className="row">
               ...
               <p className="text-muted mb-0">
                 {oneInfluenceurData 
                 && oneInfluenceurData.User
                  && oneInfluenceurData.User.email}</p>
               </div>
             </div>
             <hr/>
             ...
             <div className="row">
               ...
               <p className="text-muted mb-0">
                 {oneInfluenceurData 
                  && oneInfluenceurData.situationFamiliale}</p>
               </div>
             </div>
             ...
             <div className="row">
               ...
               <p className="text-muted mb-0">
                 {oneInfluenceurData 
                  && oneInfluenceurData.niveauEtude}</p>
               </div>
             </div>
