...
import { getOneInfluenceurUserId, updateInfluenceur } from '../../../redux/actions/influenceur.actions';
 ...
 //!------------------------------------------
  ...
  const handleEdit=(event)=>{
   event.preventDefault();
    updateInfluenceur(oneInfluenceurData?.id,inputValue,langueMulti,interetMulti,dispatch);
  }
        ...
        <div className="col-md-12">
            <div className="card">
                ...
                <form onSubmit={(e)=>handleEdit(e)}>  
                    ...
                    <div className="mb-3">
                      <label htmlFor="nomDirecteur">genre: </label>
                      <select 
                             name="quartier"
                             className='form-control'
                             onChange={(e)=>handleChange(e)}
                           >
                             ...
                             {                                
                               ...
                               ? 
                               <option selected={true}  value="homme">homme</option>   
                               :
                    ...
                    <div className="mb-3">
                      ...
                      <select 
                           ...
                           >
                             ...
                             <option 
                             selected={
                              oneInfluenceurData.situationFamiliale==="célébataire" ? true : false
                             } 
                             value="célébataire">célébataire</option>
       
                            <option 
                             selected={
                              oneInfluenceurData.situationFamiliale==="marié" ? true : false
                             } 
                            value="marié">marié</option>
                            <option 
                            selected={
                              oneInfluenceurData.situationFamiliale==="divorcé" ? true : false
                             } 
                            value="divorcé">divorcé</option>
                            <option 
                            selected={
                              oneInfluenceurData.situationFamiliale==="veuf" ? true : false
                             } 
                            value="veuf">veuf</option>   
                       </select>
                    </div>
                    ...
                    <div className="mb-3">
                      <label htmlFor="nombreEnfant">nombre enfant: </label>
                       <input 
                        name="nombreEnfant"
                        id="nombreEnfant" 
                        type="number"
                    ...
                    <div className="mb-3">
                      <label htmlFor="niveauEtude">niveau d'etude: </label>
                       <input 
                        ...
                        type="text"
                        className="form-control" 
                        defaultValue={oneInfluenceurData?.niveauEtude}
                        onChange={(e)=>handleChange(e)}
                       />
                    </div>
                    ...
                    <div className="mb-3">
                      <label htmlFor="email">youtube username: </label>
                       <input 
                        name="email"
                        id="email" 
                        type="text"
                    ...
                    <div className="mb-3">
                      <label htmlFor="email">facebook username: </label>
                       <input 
                        name="email"
                        id="email" 
                        type="text"
